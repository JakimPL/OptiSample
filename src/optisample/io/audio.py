"""Read and write audio clips as float WAV files -- the on-disk interchange format for recordings."""
...
def write_wav(path: Path | str, samples: NDArray[np.floating], sample_rate: int) -> None:
