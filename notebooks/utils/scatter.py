...
_REPRESENTATIVE_SIZE: Final = 15  # how big the ring around the take standing for a group is drawn on a plane
_REPRESENTATIVE_SOLID_SIZE: Final = 11  # how big that ring is drawn in a box, over the smaller points there
