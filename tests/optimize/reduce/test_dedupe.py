...
def test_required_duration_never_falls_below_what_loop_detection_needs(
    ...
    assert required_duration_s(0.01, config, loop_config) == pytest.approx(loop_reserve_s)
...
def test_the_loop_floor_holds_the_requirement_up_through_the_trim(
    ...
    assert required_duration_s(4.0, config, loop_config) == pytest.approx(loop_reserve_s)
